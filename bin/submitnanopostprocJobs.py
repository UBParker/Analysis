...
parser.add_argument('--n', dest = 'NAMETAG', default= '2017_DYM50' )# if NAMETAG == 'none' then make jobs for all files, otherwise specify a nametag e.g. '2017_DYM10to50' or 'SMEFTfr' for signal
